...
<nav class="sidebar sidebar-offcanvas shadow" style="background-color: rgb(3, 164, 237);" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item nav-category">Data SPK SAW</li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" style="cursor: pointer;" onclick="window.location.href='warga'">
        <i class="mdi mdi-account-multiple-outline menu-icon"></i>
        <span class="menu-title">Warga</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" style="cursor: pointer;" onclick="window.location.href='penilaian'">
        <i class="mdi mdi-account-multiple-outline menu-icon"></i>
